...
if (isset($_POST['submit'])) {
    ...
    $select = " SELECT * FROM patient WHERE patient_email = '$email' && password = '$pass'";
...
<body style="background-color: rgb(160, 255, 255); ">
    <div class="container" style="height:500px;">
        ...
        <div class="login-head">
            ...
            <div class="word2">Login as medicalstore</div>
            <?php
        ...
        <div class="reg">Booking an appointment<a href="appointment.php">Book Now</a></div>
    </div>
